...
Differences between the original Matlab implementation by Prof. James M.Kates:
    ...
    4). We only confirm output results are correct in the case of normal hearing condition, i.e., HL=[0,0,0,0,0,0]. Although HL vector can be set arbitrary in the function, we cannot guarantee results are correct since lack of extensive test.
